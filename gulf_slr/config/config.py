...
flags.DEFINE_string(
    "model_dir", "./data/small_model/", "path to store the checkpoints of the model"
)
flags.DEFINE_string(
    "summary_dir", "./summary", "path to store analysis summaries used for tensorboard"
)
...
flags.DEFINE_string(
    "visual_dir", "./visualization/", "path to store visualization codes and data"
)

flags.DEFINE_string(
    "data_dir", "../data/loc_100sp_nlcd2011.npy", "The path of input observation data"
)
# tf.app.flags.DEFINE_string('srd_dir', '../data/loc_ny_nlcd2006.npy','The path of input srd data')
flags.DEFINE_string(
    "train_idx", "../data/train_idx.npy", "The path of training data index"
)
flags.DEFINE_string(
    "valid_idx", "../data/valid_idx.npy", "The path of validation data index"
)
flags.DEFINE_string(
    "test_idx", "../data/test_idx.npy", "The path of testing data index"
)

flags.DEFINE_integer(
    "batch_size", 50, "the number of data points in one minibatch"
)  # 128
flags.DEFINE_integer(
    "testing_size", 50, "the number of data points in one testing or validation batch"
)  # 128
...
flags.DEFINE_integer(
    "z_dim",
    20,
    "z dimention: the number of the independent normal random variables in DMSE \
